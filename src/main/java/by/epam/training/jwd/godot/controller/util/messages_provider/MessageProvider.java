...
public class MessageProvider {
    ...
    private static final String BUNDLE_BASE_TITLE = "locale";
        ...
        public MessageProvider(Locale locale){
            ...
            messages.put(RetrievingException.class.getSimpleName(), rb.getString(RETRIEVING_ERROR));
            messages.put(NewPasswordMismatchException.class.getSimpleName(), rb.getString(PASSWORD_MISMATCH));
            messages.put(RequestParam.ORDER_UID, rb.getString(UID_INFO));
            messages.put(RequestParam.SEND_PSW_UPDATE_MSG, rb.getString(MESSAGE_EMAIL_SENT));
            messages.put(BannedEmailException.class.getSimpleName(), rb.getString(EMAIL_BANNED));
            messages.put(MessagingException.class.getSimpleName(), rb.getString(MESSAGE_ERROR));
    }
