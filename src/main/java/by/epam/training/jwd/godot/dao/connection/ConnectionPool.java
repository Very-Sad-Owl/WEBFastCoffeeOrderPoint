...
import by.epam.training.jwd.godot.dao.connection.recource_provider.DBParameter;
...
public class ConnectionPool {
    ...
    public ConnectionPool() throws ConnectionPoolException {
        ...
        try {
            this.size = Integer.parseInt(resourceManager.getValue(DBParameter.POOL_SIZE));
